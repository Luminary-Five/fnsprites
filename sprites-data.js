...
const baseSprites = [
    ...
    { id: "air_basic", name: "Air", theme: "Basic", rarity: "Rare", unreleased: true, releaseDate: "2026-07-16" },
    { id: "air_gold", name: "Gold Air", theme: "Gold", rarity: "Special", unreleased: true, releaseDate: "0000-00-00" },
    { id: "air_candy", name: "Gummy Air", theme: "Candy", rarity: "Special", unreleased: true, releaseDate: "0000-00-00" },
    { id: "air_galaxy", name: "Galaxy Air", theme: "Galaxy", rarity: "Special", unreleased: true, releaseDate: "0000-00-00" },
	//  { id: "air_gem", name: "Gem Air", theme: "Gem", rarity: "Special", unreleased: true, releaseDate: "0000-00-00" },
    { id: "air_holofoil", name: "Holofoil Air", theme: "Holofoil", rarity: "Special", unreleased: true, releaseDate: "0000-00-00" },
	
    { id: "seven_basic", name: "Seven", theme: "Basic", rarity: "Legendary", unreleased: true, releaseDate: "0000-00-00" },
    { id: "seven_gold", name: "Gold Seven", theme: "Gold", rarity: "Special", unreleased: true, releaseDate: "0000-00-00" },
    { id: "seven_candy", name: "Gummy Seven", theme: "Candy", rarity: "Special", unreleased: true, releaseDate: "0000-00-00" },
    { id: "seven_galaxy", name: "Galaxy Seven", theme: "Galaxy", rarity: "Special", unreleased: true, releaseDate: "0000-00-00" },
	//  { id: "seven_gem", name: "Gem Seven", theme: "Gem", rarity: "Special", unreleased: true, releaseDate: "0000-00-00" },
    { id: "seven_holofoil", name: "Holofoil Seven", theme: "Holofoil", rarity: "Special", unreleased: true, releaseDate: "0000-00-00" },

    { id: "wick_basic", name: "John Wick", theme: "Basic", rarity: "Mythic", unreleased: true, releaseDate: "0000-00-00" },

    { id: "batman_basic", name: "Batman", theme: "Basic", rarity: "Mythic", unreleased: true, releaseDate: "2026-07-16" },
